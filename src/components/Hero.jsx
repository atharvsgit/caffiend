    ...
    return (
        <>
            ...
            <div className="card info-card">
                ...
                <p>This means that after 5 hours , half the caffeine you consumed is still in your system keeping you alert longer. So if you drink a cup of coffee with 200mg of caffeine 5 hours later, you&apos;ll still have a 100mg of caffeine in your system</p>
            </div>
        </>
    )
}